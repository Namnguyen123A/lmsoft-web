...
export default function NoCases() {
    return (
        <div className="section no-cases animate" data-background="#ffffff" data-theme="header-white">
            <div className="container">
                <div className="h2">Haven't found the case in your business sector?</div>

                <p style={{marginBottom: '20px'}}>Discover more projects developed by our software development company</p>
